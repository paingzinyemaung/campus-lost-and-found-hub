...
export default function Landing() {
  return (
    <div className="min-h-screen bg-base-200 flex flex-col font-sans">
      ...
      {/* Hero Section */}
      <section className="hero py-20 lg:py-32 bg-base-200">
        <div className="hero-content text-center px-4 max-w-4xl mx-auto">
          <div className="space-y-6">
            ...
            {/* Main Headline */}
            <h1 className="text-4xl md:text-6xl font-black tracking-tight text-base-content leading-[1.2]">
              ပစ္စည်းပျောက်လို့ စိတ်ပူနေပြီလား?{' '}
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              <Link
                to="/dashboard"
                className="btn btn-primary btn-lg w-full sm:w-auto shadow-md gap-2"
              >
